...
char nodes_file[MAX_STRING], words_file[MAX_STRING], hin_file[MAX_STRING], output_file[MAX_STRING], kappa_file[MAX_STRING];
int binary = 0, num_threads = 1, vector_size = 100, negative = 5, edge_type_count = 1;
...
void TrainModel() {
	...
	words.output(output_file, kappa_file, binary);
}
