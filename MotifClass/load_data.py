...
def extract_keywords(data_path, vocab, class_type, num_keywords, data, perm):
	...
	tfidf = TfidfVectorizer(norm='l2', sublinear_tf=True, max_df=0.2, lowercase=False, stop_words='english')
...
def load_cnn(dataset_name, sup_source, num_keywords=1, with_evaluation=True, truncate_len=None):
...
def load_rnn(dataset_name, sup_source, num_keywords=1, with_evaluation=True, truncate_len=None):
	data_path = './' + dataset_name
	data, y = read_file(data_path, with_evaluation)
